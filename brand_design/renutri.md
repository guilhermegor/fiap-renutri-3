...
| `--ripeness-critical` | `use já` | `#f87171` | 1–2 days to expiry | Filled circle | `#450a0a` (red-950) |
...
| `--ripeness-critical` | `use já` | `#fca5a5` | Red-300 — red-400 #f87171 reads fine but -300 adds more pop |
